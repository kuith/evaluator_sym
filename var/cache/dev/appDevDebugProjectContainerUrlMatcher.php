...
class appDevDebugProjectContainerUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/marks/index') && preg_match('#^/marks/index/(?P<idCourse>[^/]+)(?P<idStudent>[^/]+)(?P<idPartial>[^/]++)$#s', $pathinfo, $matches)) {
            return $this->mergeDefaults(array_replace($matches, array('_route' => 'evaluator_index_marks')), array (  '_controller' => 'EvaluatorBundle\\Controller\\MarkController::courseMarksAction',));
        }
